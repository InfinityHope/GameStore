                    ...
                    <>
                        ...
                        <div className={styles.pageWrapper}>
                            ...
                            <div className={styles.pageWrapperRight}>
                                <div className={styles.pageWrapperRightHeader}>
                                    <h2>{product.title}</h2>
                                    <button
                                        className={
                                            inFavourites
                                ...
                                <div className={styles.pageWrapperRightBody}>
                                    <p>
                                    ...
                                    <ul className={styles.SubInfo}>
                                        ...
                                        <li>
                                            ...
                                            <b>{product.regionActivation}</b>
                                        </li>
                                        <li>
                                            <span>Сервис активации</span>
                                            <b>{product.serviceActivation}</b>
                                        </li>
                                    </ul>
                                </div>
                                <div className={styles.pageWrapperRightContent}>
                                    ...
                                    <Tabs
                                        tabs={[
                                            {
                                                name: 'Описание',
                                                content: <DescriptionView product={product} />,
                                            },
                                            {
                                                name: 'Системные требования',
                                                content: <RequirementsView product={product} />,
                                            },
                                        ]}
                                    />
                                </div>
